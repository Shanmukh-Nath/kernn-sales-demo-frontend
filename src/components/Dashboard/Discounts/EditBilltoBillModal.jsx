...
function EditBilltoBillModal({ discount, changeTrigger, isAdmin }) {
  ...
  const [minQuantity, setMinQuantity] = useState(discount.minQuantity);
  ...
  const onSubmitClick = () => {
    // console.log(name, minQuantity, discountPerUnit);
    ...
    async function create() {
      try {
        ...
        const res = await axiosAPI.put(
          `/discounts/bill-to-bill/${discount.id}`,
          {
            productType,
...
export default EditBilltoBillModal;

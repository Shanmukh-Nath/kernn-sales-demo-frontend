...
function DeleteDropOffRuleModal() {
  ...
  const onDelete = () => {
    ...
    async function del() {
      try {
        setLoading(true);
        const res = await axiosAPI.delete(`/drop/rules/${rule}`);
        // console.log(res);
                    ...
                    >
                      ...
                      {rules.map((rule) => (
                        <option key={rule.id} value={rule.id}>
                         {rule.minQuantity} - {rule.maxQuantity} - {rule.unit}
                        </option>
                      ))}
                    </select>
                  )}
...
export default DeleteDropOffRuleModal;
